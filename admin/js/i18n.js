...
const STRINGS = {
  en: {
    ...
    "form.seshuName": "Grave custodian (seshu)",
    "ph.seshuName": "山田太郎",
    "hint.seshuName": "Person responsible for the grave, shown in the kiosk search results.",
  ...
  ja: {
    ...
    "form.seshuName": "施主",
    "ph.seshuName": "山田太郎",
    "hint.seshuName": "お墓の管理責任者のお名前。キオスクの検索結果に表示されます。",
    "form.birthDate": "生年月日",
    "form.deathDate": "没年月日",
