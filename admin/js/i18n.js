...
const STRINGS = {
  en: {
    ...
    "nf.hint": "Give the family a name, then optionally add existing profiles to it. You can create the family now and add members later — an empty family is fine.",
    "nf.name": "Family name",
    "nf.namePh": "e.g. 山田家",
  ...
  ja: {
    ...
    "nf.title": "ご家族を作成",
    "nf.hint": "ご家族の名前を入力し、必要に応じて既存のプロフィールを追加してください。今は名前だけで作成し、あとからメンバーを追加することもできます（メンバーがいなくても作成できます）。",
    "nf.name": "ご家族の名前",
    "nf.namePh": "例：山田家",
    "nf.members": "ご家族（任意）",
